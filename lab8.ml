...
......................................................................*)
  ...
  let add_listener (evt : 'a event) (listener : 'a -> unit) : id =
    let added_id = new_id () in
    evt := {id = added_id; action = listener} :: !evt; added_id
...
let lsnr1 = WEvent.add_listener newswire fakeNewsNetwork ;;
let lsnr2 = WEvent.add_listener newswire buzzFake ;;
...
WEvent.remove_listener newswire lsnr1 ;;
WEvent.remove_listener newswire lsnr2 ;;
